...
const inputClass = "rounded-xl border border-[#C4A048]/20 bg-black/45 px-3 py-2 text-sm text-slate-100 outline-none placeholder:text-slate-600 focus:border-[#C4A048]/55 focus:ring-2 focus:ring-cyan-300/10";
  ...
  return (
    <div className="space-y-5 text-slate-100">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <div className="rounded-2xl border border-[#C4A048]/25 bg-black/35 p-4 shadow-[0_0_32px_rgba(196,160,72,0.08)]"><span className="font-mono text-[0.62rem] font-semibold uppercase tracking-[0.16em] text-slate-500">Active tenants</span><p className="mt-2 font-mono text-2xl font-semibold text-[#EDE8DC]">{activeTenants}</p></div>
      ...
      {tenantsQuery.isLoading ? (
        <div className="flex items-center justify-center rounded-2xl border border-[#C4A048]/20 bg-black/30 p-8 text-sm text-slate-400"><Loader2 className="mr-2 animate-spin text-[#E8C87A]" size={16} /> Loading tenants...</div>
      ) : (
