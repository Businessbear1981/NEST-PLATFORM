...
export default function DeskPage() {
  ...
  useEffect(() => { fetch(`${API}/api/desks/operations/agents`).then(r => r.json()).then(d => d.success && setAgents(d.data)).catch(() => {}) }, [])
  return (
    <div>
      <h1 style={{ fontFamily: 'var(--font-cormorant)', fontSize: 24, color: '#C4A048', marginBottom: 4 }}>Operations Desk</h1>
      <p style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: '#2D4A35', marginBottom: 20 }}>Post-closing administration, debt service, covenant monitoring</p>
